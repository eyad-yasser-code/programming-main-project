...
class WrapperTop extends JPanel {
    ...
    public WrapperTop(JPanel panel, ShopWindow shopWindow, MainWrapper mainWrapper) {
        ...
        // DESIGN: slightly deeper top bar for breathing room
        this.setBackground(Color.decode("#0e0e0e"));

        JPanel leftPanel   = new JPanel(new FlowLayout(FlowLayout.LEFT,  8, 7));
        JPanel middlePanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 0, 7));
        JPanel rightPanel  = new JPanel(new FlowLayout(FlowLayout.RIGHT,  8, 7));
        ...
        searchField.addTextListener(new DocumentListener() {
            ...
            private void update() {
                ...
                shopWindow.getHomeWindow().showSearchedProducts(results);
            }
        });
...
class WrapperSide extends JPanel {
    ...
    public WrapperSide(MainWindow mainWindow, MainWrapper mainWrapper, ShopWindow shopWindow) {
        ...
        this.setLayout(new BorderLayout());
        this.setPreferredSize(new Dimension(260, 0)); // DESIGN: slightly narrower
        ...
        category.setMaximumSize(new Dimension(230, 36));
        category.setPreferredSize(new Dimension(230, 36));
        ...
        loginBtn.setMaximumSize(new Dimension(230, 36));
        loginBtn.setPreferredSize(new Dimension(230, 36));
