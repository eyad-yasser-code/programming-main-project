...
public class AdminAddCategory extends JPanel{
        ...
        public AdminAddCategory(ShopWindow shopWindow,AdminWrapper adminWrapper ){
            ...
            Top top = new Top(0,0,0,getHeight(),topDegrees,topColors,30);
                    ...
                    confirm.addActionListener(e->{
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(this,"Please enter a valid image","WARNING",JOptionPane.WARNING_MESSAGE);
                            return;
                            ...
                            if(accepted){
                                ...
                                int response = ApiService.addCategory(name,imageName,categoryId);
    
                                shopWindow.addCategory(categoryId,name,selectedFile);
