...
public class MainWindow extends JPanel{
    ...
    // going from (shopWindow) -> homeWindow -> mainWindow -> BottomBasePanel -> middleView -> itemHOlder/categoryHolder(UI) the logic is added or removed in shopWindow array
    ...
    // going from itemHolder ->middleview -> bottomBasePanle ->  mainWindow,here -> homeWindow -> (shopWindow) -> cartWindow  
    ...
    //getting allProducts from shopWindow -> homewindow to categorypanel
...
class BottomBasePanel extends JPanel{
    ...
    private Color colors[]={Color.decode("#159069"),Color.decode("#159069"),Color.decode("#161616"),Color.decode("#161616")};
    ...
    public BottomBasePanel(MainWindow mainWindow){
           ...
           middleView.setBorder(BorderFactory.createLineBorder(Color.decode("#141414"),10));
       ...
       //form mainWrapper entered text -> shopWindow search products gives filtered -> homeWindow -> mainWindow ,here - > middleView -> itemHolder
        public void showSearchedProducts(ArrayList<Product> searchedProducts){
