...
public class ShopWindow extends JPanel {
    ...
    public ShopWindow() {
        ...
        addItem(1, "Laptop",    "laptop.PNG",    "Powerful performance for work and play.",                 20000, 1);
        addItem(2, "Microphone","microphone.PNG","Studio-quality sound at your fingertips.",                  800, 2);
        addItem(3, "Mouse",     "mouse.PNG",     "Ergonomic design for all-day comfort.",                     500, 2);
        addItem(4, "Keyboard",  "keyboard.PNG",  "Mechanical keys with satisfying tactile feedback.",        1000, 2);
        addItem(5, "Monitor",   "laptop.PNG",    "Crisp 4K display for an immersive experience.",           8000, 1);
        addItem(6, "Headset",   "microphone.PNG","Crystal-clear audio with noise cancellation.",            1500, 2);
    ...
    public void addItem(int id, String name, String imageName,
    ...
    public void removeItem(int id) {
        ...
        for (Product p : products) {
            if (p.getId() == id) { removable = p; break; }
        }
        if (removable != null) {
    ...
    public void removeCategory(int id) {
        ...
        for (Category c : categories) {
            if (c.getId() == id) { removable = c; break; }
        }
        if (removable != null) {
